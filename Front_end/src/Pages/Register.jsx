...
export default function Register() {
  ...
  const handleSumbit =(e) => {
    e.preventDefault()
    console.log('user register ',email,name,password);
    
  }
  return (
    <div className="flex">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
        <form onSubmit={handleSumbit} className="w-full max-w-md bg-white border-gray-200 p-8 rounded-lg border shadow-sm">
